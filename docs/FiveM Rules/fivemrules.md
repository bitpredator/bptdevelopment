...
- Non è permesso utilizzare sistemi di chat vocale terzi al di fuori della chat vocale di gioco;
...
# 3. BUG ABUSING:
E' Severamente vietato utilizzare dei bug che vengono pervenuti all'interno del gioco per avvantaggiarsi rispetto ad altri giocatori;
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban e dei giorni di divieto a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.
...
E' obbligatorio utilizzare nomi che non siano di persone famose, che non contengano frasi troll o ingiuriose.
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban in maniera permanente,
  potrai richiedere eventualmente il cambio del nome tramite ticket discord. 
  nel caso in cui la richiesta di supporto sia valutata come richiesta Troll (sarà confermato il perma ban dal server di gioco e dal server discord senza possibilità di replica)
...
# 7. Metagame
- Se il tuo personaggio nel gioco non conosce un altro giocatore non va chiamato per nome, finchè lui non si presenterà o ti mostrerà eventuali documenti. Inoltre non puoi utilizzare informazioni che hai ricavato fuori dal gioco e trasmetterle successivamente al tuo personaggio senza esserene entrato realmente in possesso durante il gioco.
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban e dei giorni di divieto a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.

# 8. POWERGAME
- Il roleplay non puo' essere forzato per un tornaconto personale.
Questa definizione include:
(1) Sfruttare la fisica di GTA per compiere azioni umanamente non possibili;
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban e dei giorni di divieto a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.

# 9. RDM + VDM
- Il Random Deathmatch & Vehicle Deathmatch sono severamente vietatiall'interno del server.
  Ogni azione deve essere eseguita con una motivazione roleplay valida.
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban e dei giorni di divieto a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.
...
# 11. BUNNYHOP
- Saltare ripetutamente per velocizzare la corsa è severamente vietato.
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban e dei giorni di divieto a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.

# 12. RAGE QUIT
- E' severamente vietato disconnettersi dal gioco durante un'azione o semplicemente quando qualcuno sta iniziando un azione roleplay con voi. Se avete urgenza di uscire comunicate alla persona che sta interagendo con voi di riprendere la scena roleplay in un secondo momento. Inoltre, un membro dello staff deve essere avvisato di tale azione.
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban e dei giorni di divieto a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.

# 13. FARMING + AFK
- E' vietato il farming rimanendo AFK all'interno del server per guadagnare lo stipendio. Il tempo limite per l'afk è di 10 minuti.
* La punizione di questa regola funziona nel seguente modo:
- Emissione del ban o eventuale kick a discrezione dell'amministratore,
  eventualmente puoi contestare il ban tramite ticket in discord.
